...
const Services = ({ isSinglePage }) => {
  ...
  return (
    <div className={isSinglePage ? "w-full box-border" : "pt-[100px] sm:pt-[120px] w-full min-h-screen bg-[#f8f9fa] box-border"}>
      <section className={isSinglePage ? "pt-4 sm:pt-6 pb-8 sm:pb-12 bg-white text-center box-border px-4 sm:px-6 lg:px-8" : "services-grid-section px-4 sm:px-6 lg:px-8"}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center mb-12 md:mb-16">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-[#0d1b2a] tracking-tight leading-tight w-full font-sans uppercase">
